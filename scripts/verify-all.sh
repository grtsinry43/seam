...
just build-ts
run_parallel "lint" "just lint-ts lint-go lint-deps lint-links" "typecheck" "just typecheck" "test-rs" "just test-rs" "test-ts" "just test-ts" "test-go" "just test-go" "test-swift" "just test-swift"
